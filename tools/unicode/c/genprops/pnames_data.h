...
#define UNICODE_VERSION { 17, 0, 0, 0 }
...
static const Value VALUES_blk[347] = {
    ...
    Value(UBLOCK_ARABIC_EXTENDED_B, "Arabic_Ext_B Arabic_Extended_B"),
    Value(UBLOCK_CYPRO_MINOAN, "Cypro_Minoan Cypro_Minoan"),
    Value(UBLOCK_ETHIOPIC_EXTENDED_B, "Ethiopic_Ext_B Ethiopic_Extended_B"),
    Value(UBLOCK_KANA_EXTENDED_B, "Kana_Ext_B Kana_Extended_B"),
    Value(UBLOCK_LATIN_EXTENDED_F, "Latin_Ext_F Latin_Extended_F"),
    Value(UBLOCK_LATIN_EXTENDED_G, "Latin_Ext_G Latin_Extended_G"),
    Value(UBLOCK_OLD_UYGHUR, "Old_Uyghur Old_Uyghur"),
    Value(UBLOCK_TANGSA, "Tangsa Tangsa"),
    Value(UBLOCK_TOTO, "Toto Toto"),
    Value(UBLOCK_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED_A, "UCAS_Ext_A Unified_Canadian_Aboriginal_Syllabics_Extended_A"),
    Value(UBLOCK_VITHKUQI, "Vithkuqi Vithkuqi"),
    Value(UBLOCK_ZNAMENNY_MUSICAL_NOTATION, "Znamenny_Music Znamenny_Musical_Notation"),
    Value(UBLOCK_ARABIC_EXTENDED_C, "Arabic_Ext_C Arabic_Extended_C"),
    Value(UBLOCK_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_H, "CJK_Ext_H CJK_Unified_Ideographs_Extension_H"),
    Value(UBLOCK_CYRILLIC_EXTENDED_D, "Cyrillic_Ext_D Cyrillic_Extended_D"),
    Value(UBLOCK_DEVANAGARI_EXTENDED_A, "Devanagari_Ext_A Devanagari_Extended_A"),
    Value(UBLOCK_KAKTOVIK_NUMERALS, "Kaktovik_Numerals Kaktovik_Numerals"),
    ...
    Value(UBLOCK_TAI_YO, "Tai_Yo Tai_Yo"),
    Value(UBLOCK_TANGUT_COMPONENTS_SUPPLEMENT, "Tangut_Components_Sup Tangut_Components_Supplement"),
...
static const Value VALUES_jg[106] = {
    ...
    Value(U_JG_THIN_NOON, "Thin_Noon Thin_Noon"),
};
...
static const Value VALUES_lb[49] = {
    ...
    Value(U_LB_AKSARA, "AK Aksara"),
    Value(U_LB_AKSARA_PREBASE, "AP Aksara_Prebase"),
    Value(U_LB_AKSARA_START, "AS Aksara_Start"),
    Value(U_LB_VIRAMA_FINAL, "VF Virama_Final"),
    Value(U_LB_VIRAMA, "VI Virama"),
    Value(U_LB_UNAMBIGUOUS_HYPHEN, "HH Unambiguous_Hyphen"),
};
...
static const Value VALUES_sc[212] = {
    ...
    Value(USCRIPT_CYPRO_MINOAN, "Cpmn Cypro_Minoan"),
    Value(USCRIPT_OLD_UYGHUR, "Ougr Old_Uyghur"),
    Value(USCRIPT_TANGSA, "Tnsa Tangsa"),
    Value(USCRIPT_TOTO, "Toto Toto"),
...
static const Value VALUES_ID_Type[12] = {
    ...
    Value(U_ID_TYPE_NOT_NFKC, "Not_NFKC Not_NFKC"),
    Value(U_ID_TYPE_NOT_XID, "Not_XID Not_XID"),
    Value(U_ID_TYPE_EXCLUSION, "Exclusion Exclusion"),
    Value(U_ID_TYPE_OBSOLETE, "Obsolete Obsolete"),
    Value(U_ID_TYPE_TECHNICAL, "Technical Technical"),
    Value(U_ID_TYPE_UNCOMMON_USE, "Uncommon_Use Uncommon_Use"),
    Value(U_ID_TYPE_LIMITED_USE, "Limited_Use Limited_Use"),
    Value(U_ID_TYPE_INCLUSION, "Inclusion Inclusion"),
...
static const Property PROPERTIES[121] = {
    ...
    Property(UCHAR_JOINING_GROUP, "jg Joining_Group", VALUES_jg, 106),
